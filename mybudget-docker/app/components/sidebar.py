...
layout = dbc.Col([
    ...
    dbc.Button(id='botao_avatar',
            children=[html.Img(src='/assets/img_controlwallet.png', id='avatar_change', alt='Avatar', className='perfil_avatar'),
...
nao         # Modal Despesa
        dbc.Modal([
            ...
            dbc.ModalBody([
                dbc.Row([
                    dbc.Col([
                        dbc.Label('Descrição: '),
                        dbc.Input(placeholder="Ex. Gasolina, petshop, etc...", id="txt-despesa")
                    ], width=6),
                    dbc.Col([
                        dbc.Label("Valor: "),
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        dbc.Label("Extras"),
                        dbc.Checklist(
                            options=[{"label": "Foi pago", "value": 1},
    ...
    ThemeChangerAIO(aio_id="theme", radio_props={"value":dbc.themes.MORPH}),
